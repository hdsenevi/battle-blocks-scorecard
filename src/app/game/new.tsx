      ...
      >
        ...
        >
          ...
          <View className="flex-row gap-3 mb-6">
            <TextInput
              className={`flex-1 border border-gray-border-medium dark:border-stone-600 rounded-button px-4 ${
                Platform.OS === "ios"
                  ? "py-3 min-h-[44px]"
                  : Platform.OS === "android"
                  ? "py-3.5 min-h-[48px]"
                  : "py-3 min-h-[44px]"
              } text-base font-sans bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-50`}
            ...
            />
            <TouchableOpacity
              className={`bg-primary dark:bg-primary-bright px-6 ${
                Platform.OS === "ios"
                  ? "py-3 min-h-[44px] min-w-[44px]"
                  : Platform.OS === "android"
                  ? "py-3.5 min-h-[48px] min-w-[48px]"
                  : "py-3 min-h-[44px] min-w-[44px]"
              } rounded-button justify-center shadow-elevated`}
          ...
          {players.length > 0 && (
            <View className="mb-6">
              ...
              {players.map((player) => (
                <View
                  key={player.id}
                  className="flex-row justify-between items-center py-3 px-4 border-b border-gray-border dark:border-stone-600"
                >
          ...
          <TouchableOpacity
            className={`${
              Platform.OS === "ios"
                ...
                ? "py-[18px] min-h-[48px]"
                : "py-4 min-h-[44px]"
            } px-6 rounded-button items-center shadow-elevated ${
              players.length < 2 || isCreating
                ? "bg-stone-400 dark:bg-stone-600 opacity-60"
