...
- [x] Implement accessibility (AC: 7)
  ...
  - [x] Use icons, text, or patterns in addition to color (👑 Leader badge with text)
...
- Visual highlighting implemented in PlayerCard component:
  ...
  - "👑 Leader" badge displayed prominently
...
- Accessibility features:
  ...
  - Uses icon (👑) and text ("Leader") in addition to color
