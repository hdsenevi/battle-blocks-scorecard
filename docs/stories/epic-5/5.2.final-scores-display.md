...
8. **And** a Maestro automation test flow is created in `.maestro/flows/` that:
    ...
    - Verifies the winner announcement screen displays final scores for all players
    - Verifies all players are listed with their final scores
    - Verifies scores are displayed clearly and prominently
    - Verifies the winner is highlighted or shown first
    - Verifies the final scores are accurate and match the last game state
    - Verifies the display is clear and easy to read
